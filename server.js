...
Правила:
- Если указано "вчера", это дата ${todayString} минус один день.
- Если указано "позавчера", это дата ${todayString} минус два дня.
- Если указано "10 дней назад", это ${todayString} минус 10 дней.
- Если дата не указана, ставь сегодняшнюю (${todayString}).
- Если время не указано, ставь с "00:00" до "23:59".
- Если указано "в 9 вечера", это с "21:00" до "21:59". То же самое для других чисел и частей суток.
- Учитывай слова "утром", "днём", "вечером", "ночью" для определения времени.
